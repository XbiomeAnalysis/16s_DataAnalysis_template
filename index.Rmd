...
[1]: paste0('Importing data: import_dada2_taxa()/import_dada2()/summarize_phyloseq()')
[2]: paste0('Quality Control(Reads Track): plot_Dada2Track()')
[3]: paste0('Quality Control(RefCheck/Remove): summarize_taxa()/run_RefCheck()/get_GroupPhyloseq()')
[4]: paste0('Quality Control(Rarefaction curves): plot_RarefCure()/summarize_phyloseq()')  
[5]: paste0('Data processing(Rarefy): norm_rarefy()') 
[6]: paste0('Data processing(Extract specific taxonomic level): summarize_taxa()') 
[7]: paste0('Data processing(Filter&trim): run_filter()/run_trim()') 
[8]: paste0('GlobalView(Alpha diveristy): run_alpha_diversity()/plot_boxplot()') 
[9]: paste0('GlobalView(Beta diveristy): run_beta_diversity()/run_permanova()/run_ordination()/plot_Ordination()') 
[10]: paste0('GlobalView(microbial composition): plot_StackBarPlot()/plot_core_taxa()/core_members()')
[11]: paste0('DifferentialAnalysis: run_lefse()/plot_lefse()/run_wilcox()/plot_volcano()')
")
```
